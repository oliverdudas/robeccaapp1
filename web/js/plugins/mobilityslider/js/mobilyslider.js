    ...
    $.fn.mobilyslider = function(options) {
        ...
        return this.each(function() {
            ...
            var slider = {init:function() {
                ...
                item.eq(step).animate({left:sign + "=" + w}, sets.animationSpeed,
                        function() {
                ...
                sets.animationStart.call(this);
                item.eq(step).animate({top:sign + "=" + h}, sets.animationSpeed,
                        function() {
                            slider.zindex.trigger()
                ...
                step == 0 ? step = l : step--;
                z = -1;
                switch (sets.transition) {case"horizontal":slider.slide.left("-");break;case"vertical":slider.slide.top("+");break;case"fade":slider.slide.fade();break
                }
            },next:function() {
                step == l ? step = 0 : step++;
                z = 1;
                ...
                bullet.click(function() {
                    ...
                    if (!b.hasClass("active")) {
                        switch (sets.transition) {case"horizontal":slider.slide.left(sign);break;case"vertical":slider.slide.top(sign);break;case"fade":slider.slide.fade();break
                        }
                    }
